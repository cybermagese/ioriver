...
class Device {
    ...
    needBatteryUpdate() {
        return this.hasParentUnit() && this.parentUnit.byConnectionIO[this.name2ConnectionIO.battery] 
        && this.parentUnit.byConnectionIO[this.name2ConnectionIO.battery].value 
    ...
    need2UpdateInput(name) {
        ...
        return this.parentUnit && this.parentUnit.byConnectionIO[ConnectionIO] && this.getInputByName(name) && this.parentUnit.byConnectionIO[ConnectionIO].value !== this.getInputByName(name).value;
    }
    ...
    isSensor() {
        return (typeof this.config.type !== `undefined` && this.config.type === 'sensor');
    }

    isDevice() {
        return (typeof this.config.type !== `undefined` && this.config.type === 'device');
    }
