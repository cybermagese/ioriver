...
class Device {
    ...
    needBatteryUpdate() {
        ...
        && this.hasParentUnit() 
        && typeof this.parentUnit.byConnectionIO !== 'undefined' 
    ...
    isSensor() {
        if(typeof this.config.isSensor === 'undefined') return false;
        return this.config.isSensor;
    }

    isDevice() {
        if(typeof this.config.isDevice === 'undefined') return false;
